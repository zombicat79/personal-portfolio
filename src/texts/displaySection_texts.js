const displayTexts = {
    ...
    intro: {
        cat: {
            ...
            paragraph3: "En aquesta pàgina web trobaràs tot allò relacionat amb la meva carrera professional i també alguna coseta sobre el meu rerefons personal.",
        ...
        esp: {
            ...
            paragraph3: "En esta página web encontrarás todo lo relacionado con mi carrera profesional y también alguna cosita sobre my trasfondo personal.",
        ...
        eng: {
            ...
            paragraph3: "On this webpage you will find all things related to my professional career as well as some insights into my personal background.",
